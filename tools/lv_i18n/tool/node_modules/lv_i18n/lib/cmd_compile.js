...
`);
  ...
  let raw_i18n_h = compiler_template.generate_file_head(sorted_locales[0],data);
  ...
  if (args.output) {
    ...
    shell.cp(join(__dirname, '../src/lv_i18n.h'), join(args.output, 'lv_i18n_back.h'));

    let txt_h = readFileSync(join(args.output, 'lv_i18n_back.h'), 'utf-8');
