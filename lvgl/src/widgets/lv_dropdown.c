...
void lv_dropdown_open(lv_obj_t * dropdown_obj)
{
    ...
    lv_obj_set_parent(dropdown->list, lv_obj_get_parent(dropdown_obj)); // TODO: PandaTouch modified from "lv_obj_get_screen" to "lv_obj_get_parent"
...
static void lv_dropdown_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    dropdown->list = lv_dropdown_list_create(lv_obj_get_parent(obj)); // TODO: PandaTouch modified from "lv_obj_get_screen" to "lv_obj_get_parent"
